...
export const StoryOriginSchema = z.enum(["bay", "hn", "lobsters", "rss", "event", "github", "sec"]);
...
export const NewsFeedSourceSchema = z.enum(["bay", "all", "hn", "lobsters", "rss", "event", "github", "sec"]);
